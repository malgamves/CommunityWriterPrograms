...
- [Arctype](https://docs.google.com/document/d/1kBqDcEIKgSftvO-GeXjeqM7WNfaajSpCHm5AZaSyh-Q/edit?usp=sharing) - $100+ per article(x)
...
- [CircleCI](https://circleci.com/blog/guest-writer-program/)  - Up to $300 per piece(x)
  > Technical tutorials with code. Pick from a list of possible articles.
...
- [Deepsource](https://deepsource.io/tech-writer/) - Around $150 per piece (x) 
...
- [Egghead](https://next.egghead.io/write-for-egghead) - Waiting for details(x)
